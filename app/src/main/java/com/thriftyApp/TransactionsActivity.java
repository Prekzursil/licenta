...
public class TransactionsActivity extends AppCompatActivity  {
    ...
    public  void setTList() {
        ...
        if (transact.isEmpty()) {
            ...
            myListView.setOnItemClickListener ((parent, view, position, id) -> Toast.makeText (TransactionsActivity.this, "Transaction  : " + finalTransact.get (position), Toast.LENGTH_LONG).show ( ));
        }
    }
